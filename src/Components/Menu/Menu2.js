...
import menu_table from "../../images/menu/menu_tablet.png"
import menu_celu from "../../images/menu/menu_celu.png"
...
function Menu2(props) {
    return (
        <Fragment>
            ...
            <main>
                <section className="py-5 text-center imagenFondo">
                ...
                <img src={menu} className={'menu_mostrar_pc'} alt={'menu'}/>
                <img src={menu_table} className={'menu_mostrar_tablet'} alt={'menu'}/>
                <img src={menu_celu} className={'menu_mostrar_cel'} alt={'menu'}/>
